...
public class ListItem extends javax.swing.JPanel {
    ...
    private final Image imageDelete = new ImageIcon(getClass().getResource("/com/icon/delete_1.png")).getImage();
    private final Image imageDeleteDisable = new ImageIcon(getClass().getResource("/com/icon/delete_disable.png")).getImage();
    private final Image imageInsert = new ImageIcon(getClass().getResource("/com/icon/insert.png")).getImage();
    private final Image imageOpen = new ImageIcon(getClass().getResource("/com/icon/open.png")).getImage();
