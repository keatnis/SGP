...
public class MyList<E extends Object> extends JList<E> {
    ...
    public MyList() {
        ...
        CumpleañosDAO dao = new CumpleañosDAO();
        //Recorrer el contenido del ArrayList
        ArrayList<ModelCumpleaños> arrayList = dao.listFestividades();
        for (int i = 0; i < arrayList.size(); i++) {
            //Añadir cada elemento del ArrayList en el modelo de la lista
            model.add(i, arrayList.get(i).getFecha() + "--" + arrayList.get(i).getNombresFestividad());
        }
...
//Asociar el modelo de lista al JList
    ...
    private final Image image = new ImageIcon(getClass().getResource("/com/icon/empty.png")).getImage();
